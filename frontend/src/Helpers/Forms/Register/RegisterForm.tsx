    ...
    <div className="register-form">
      <div className="p-4">
        <div className="register-form-header">
          <h2 className="register-form-header-title">Sukurti paskyrą</h2>
          <h3 className="register-form-header-exist">
            Jau turi paskyrą?{" "}
        ...
        <form
          className="register-body flex flex-col gap-y-2"
          onSubmit={onSubmit}
        >
          <div className="register-body-inputs flex flex-col gap-y-2">
            <Input
              name={"El.Paštas"}
          ...
          <div className="register-body-pass flex flex-col gap-y-2">
            <div className="register-body-pass-requirements">
